...
})({"hPOOY":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4b943efa39998c0c";
...
class CommentView {
    ...
    createCommentViewElement(commentElements) {
        const commentViewTemplate = document.getElementById('comment-view-template').content.cloneNode(true);
    ...
    initCommentViewInterface() {
        this.commentViewEl.querySelector('.back').addEventListener('click', this.close.bind(this));
        this.commentViewEl.querySelector('.blue-button').addEventListener('click', (e)=>{
            ...
            if (value.trim() > '') {
                ...
                const newComment = this.createCommentElement(this.post.comments[this.post.comments.length - 1]);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hPOOY"], null, "parcelRequireab7b")

//# sourceMappingURL=CommentView.39998c0c.js.map
