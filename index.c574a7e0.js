...
class RandomPost extends _postUtilsJs.PostUtils {
    ...
    async addRandomComments() {
        const commentCount = _utilityJs.getRandomInt(1, 5);
        for(let i = 0; i < commentCount; i++){
            const imageUrl = await this.fetchImage(40);
            this.addComment(_namesJs.getRandomName(), _descJs.getRandomSentence(), imageUrl);
        }
    }
    async add() {
        ...
        this.postTemplateEl.querySelector('.post-user-img img').src = this.profileImageURL;
...
class PostUtils {
    ...
    constructor(username, description = '', likes = 0){
        ...
        const pfp = this.profileImageURL ? this.profileImageURL : 'https://picsum.photos/200';
     ...
     #initButtons() {
        this.postTemplateEl.querySelector('.comment').addEventListener('click', this.viewComments.bind(this));
    ...
    addComment(username, comment, imageURL) {
        if (!username || !comment || !imageURL) throw new Error(`Username, comment text, and profle image url is REQUIRED to add a comment to a post
				Username: ${username}
				commentText: ${comment}
				imageURL: ${imageURL}`);
        this.comments.push({
    ...
    viewComments() {
        require("3c032ce351c8ccb0").then((c)=>{
    ...
    async fetchImage(px = 200) {
        ...
        if (pickNumber > 11) return await _randomPhotoJs.fetchCatPhoto(px);
...
},{"./data/RandomPhoto.js":"jSv9e","../utility/Utility.js":"jX6si","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","3c032ce351c8ccb0":"fnHm2"}],"jSv9e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fnHm2":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require('./helpers/bundle-url').getBundleURL('8e1QZ') + "CommentView.39998c0c.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root('397AM')
);
    ...
    async feedScrollHandler() {
        ...
        if (this.feedContainer.scrollTop > feedHeight - postFetchHeightThreshold) {
            if (_feedUtilJs.timestampDiffNow(this.fetchTimestamp) > this.postFetchDelay) {
                this.fetchTimestamp = Infinity;
                await new _randomPostJs.RandomPost().add();
        ...
        if (this.navItems.includes(button)) switch(this.navItems.indexOf(button)){
            case 0:
                if (!this.galleryObject) {
                    require("1bfd00e8f72c7a34").then((gall)=>{
                        this.galleryObject = new gall.Gallery();
                    });
                    return;
                } else this.galleryObject.initGallery();
                break;
            case 1:
                console.log('lajki');
                break;
...
},{"1bfd00e8f72c7a34":"l6hjn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l6hjn":[function(require,module,exports) {
...
},{"./helpers/browser/js-loader":"61B45","./helpers/bundle-url":"lgJ39"}]},["2G3IT","gJRPm"], "gJRPm", "parcelRequireab7b")
