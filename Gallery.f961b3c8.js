...
class Gallery {
    #photoUrlArr = [];
    constructor(){
        this.galleryElement = document.getElementById('gallery-template').content.cloneNode(true);
        this.initGallery();
    }
    ...
    async fetchGalleryPhotos() {
        const photos = [];
        for(let i = 0; i < 20; i++)photos.push(await this.fetchImage(150));
        return photos;
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dm7dD"], null, "parcelRequireab7b")
